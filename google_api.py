...
class DriveAPI: 
  ...
  def FileInformation(self, file_id):
  ...
  def FileDownload(self, file_id, file_name): 
    ...
    downloader = MediaIoBaseDownload(fh, request, chunksize=16380400) 
    done = False
...
if __name__ == "__main__": 
  ...
  file_id = '16WUzOXSCDmgzIytTZwUga71MDpaPFLNS'
  name = obj.FileInformation(file_id)
  obj.FileDownload(file_id, name)
  ...
  #     if line_count > 2 and line_count < 4:
